    ...
    <head>
        ...
        <style>
            :root {
                ...
                --border-radius: 8px;
                --info-color: #17a2b8;
                --info-hover-color: #138496; /* Màu cho nút Lưu Nháp */
            }
            body {
                ...
                var initialContent = `<c:out value="${post.content}" escapeXml="false"/>`;
                    if (quill && initialContent && initialContent.trim() !== '' && initialContent.trim() !== "<p><br></p>") {
                        try {
                            ...
                            console.error("Lỗi khi pasteHTML: ", e);
                        }
                    }
            </c:if>
                }
                        ...
                        try {
                            ...
                            if (response.ok) {
                                ...
                                if (result.imageUrl) {
                                    ...
                                    alert("Lỗi tải ảnh từ server: " + result.error);
                                }
                            } else {
                            ...
                            if (this.quill && !this.quill.isEnabled())
                                this.quill.enable();
